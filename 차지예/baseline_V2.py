...
try:
    ...
    KEY_JSON_PATH = r"D:\key folder\ocr-project-470906-7ffeebabeb09.json"
    ...
    kb_embeddings = np.load("정주환/kb_embeddings.npy") 
    
    with open("정주환/kb_categories.json", "r", encoding="utf-8") as f:
...
my_test_image_file = "Data/김광무_121.jpg" # 👈 'image.jpg'는 OCR 로그를 제공한 그 이미지 파일 가정
